<template>
  <div class="topbar">
    ...
    <div class="right-menu">
      ...
      <el-dropdown v-if="isShowUserDropdown" class="avatar-container right-menu-item hover-effect" trigger="click">
        ...
        <el-dropdown-menu slot="dropdown">
          ...
          <el-dropdown-item v-if="isTurnOffAuth" divided @click.native="logout">
            <span style="display:block;"><font-awesome-icon icon="sign-out-alt"/> {{ $t('topbar.logOut') }}</span>
          </el-dropdown-item>
        </el-dropdown-menu>
      </el-dropdown>
    </div>
...
export default {
  ...
  computed: {
    ...
    name() {
      return `${this.$store.getters.ufn} ${this.$store.getters.posName ? ' | ' + this.$store.getters.posName : ''}`
    },
    orgInfo() {
