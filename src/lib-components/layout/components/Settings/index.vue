  ...
  <div class="drawerContainer">
    ...
    <el-menu class="el-menu-vertical-demo" router>
      ...
      <div v-if="isShowSubMenu">
        ...
        <el-menu-item
          index="4"
          @click="isShowRequirement = !isShowRequirement"
          route="#"
        >
          <template slot="title">
      ...
      <div v-if="isShowViewDetail" :class="{ showUserManual: isActiveScroll }">
        ...
        >
          ...
          <a v-if="userManualContent" target="_blank" :href="`${getUrl}`">
            <el-button icon="el-icon-view" type="text" style="float: right">
              Xem chi tiết
            </el-button>
          </a>
        </div>
        ...
        <el-col :offset="6">
          <a href="mailto:bophanhotrotchq@customs.gov.vn">
            <p class="tag-info">
              ...
              <strong>paylink@techcombank.com.vn</strong>
            </p>
          </a>
        </el-col>
      </el-row>
...
export default {
  ...
  methods: {
    ...
    getContentUserManual() {
      ...
      apiFactory
        .callAPI(
          ConstantAPI["ql-chuc-nang"].SELECT_ITEM,
          {},
          {
        ...
        .then((rs) => {
          ...
          this.userManualContent = this.userManualContent.replaceAll(
            "<img ",
